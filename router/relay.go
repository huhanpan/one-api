...
func SetRelayRouter(router *gin.Engine) {
	...
	relayV1Router.Use(middleware.RelayPanicRecover(), middleware.TokenAuth(), middleware.Distribute())
	{
		...
		relayV1Router.DELETE("/responses/:id", controller.Relay)
		relayV1Router.POST("/responses/:id/cancel", controller.Relay)
		relayV1Router.POST("/responses/compact", controller.Relay)
		relayV1Router.POST("/responses/input_tokens", controller.Relay)
		relayV1Router.GET("/responses/:id/input_items", controller.Relay)
